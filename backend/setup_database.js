...
-- Insert sample data
INSERT INTO tours (guides_id, title, location, price, duration, time, tour_date, status) VALUES
(NULL, 'Historic Riyadh City Tour', 'Riyadh', 150.00, '4 hours', '09:00:00', '2024-02-15', 'available'),
(NULL, 'Desert Safari Adventure', 'Al Khobar', 200.00, '6 hours', '14:00:00', '2024-02-20', 'available'),
(NULL, 'Jeddah Old Town Walk', 'Jeddah', 120.00, '3 hours', '10:00:00', '2024-02-25', 'available'),
(NULL, 'Mountain Hiking Trip', 'Taif', 180.00, '8 hours', '07:00:00', '2024-03-01', 'available'),
(NULL, 'Cultural Heritage Tour', 'Diriyah', 160.00, '5 hours', '11:00:00', '2024-03-05', 'available');
...
ALTER TABLE tours ADD CONSTRAINT tours_ibfk_1 FOREIGN KEY (guides_id) REFERENCES guides(guides_id) ON DELETE SET NULL;
`;
